...
<div class="container mt-5">
        <h3 class="text-center mb-3">Daftar Menu Pengunjung</h3>
        <a href="tambah_pengunjung.php" class="btn btn-outline-primary mb-3 mt-3">Tambah Menu</a>
            ...
            <table class="container table table-bordered">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td>
                        ...
                        <a class='btn btn-outline-danger mt-3' href='hapus.php?id=".$row['id_menu']."'>Hapus</a>
                    </td>
                </tr>";
                    $no++;
                }
