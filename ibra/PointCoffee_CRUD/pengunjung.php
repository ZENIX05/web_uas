    ...
    <div id="demo" class="container carousel slide mt-5" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/morning coffee.jpg" alt="1" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="img/morning.jpg" alt="2" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="img/sunset.jpg" alt="3" class="d-block w-100">
            </div>
        </div>
