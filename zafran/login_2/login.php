...
<head>
    ...
    <style>
        /* Gradient hijau ke hitam pekat */
        .gradient-custom-2 {
            /* fallback for old browsers */
            background: #000000;

            /* Chrome 10-25, Safari 5.1-6 */
            background: -webkit-linear-gradient(to right, #041d04ff, #010703ff, #000000);

            /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
            background: linear-gradient(to right, #010701ff, #07220eff, #000000);
            color: #fff;
        }
                ...
                <form action="proses_login.php" method="POST">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 w-100" type="button" onclick="this.form.submit();" name="login">Log
                      in</button>
                    <p class="text-muted">lupa password? hubungi admin zafran.</p>
                  </div>

                  <div class="d-flex align-items-center justify-content-center pb-4">
                    <p class="mb-0 me-2">Belum punya akun?</p>
                    <a href="https://www.instagram.com/it.ikanterasi?igsh=MWV6bHQ1M2l4bGdvbQ==" class="btn btn-outline-danger" role="button">Hubungi Admin</a>
                  </div>
