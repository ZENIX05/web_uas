...
// Cek apakah ada input bernama 'status_baru' yang dikirim
if (isset($_POST['status_baru'])) {
    ...
    if($update) {
        echo "<script>alert('Status berhasil diubah menjadi $status_baru!'); window.location='transaksi.php';</script>";
    } else {
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 text-center border-start">
                            ...
                            <form method="POST" action="">
                                ...
                                <button type="submit" name="status_baru" value="Selesai" 
                                    class="btn btn-success btn-sm mb-1 w-100 <?php echo ($status == 'Selesai') ? 'disabled' : ''; ?>">
                                    Selesai
                                </button>
                                
                                <button type="submit" name="status_baru" value="Dibatalkan" 
