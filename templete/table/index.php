        ...
        <div class="table-responsive">
            <table class="container table table-bordered">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td>".$row['status']."</td>
                    <td>
                        <a class='btn btn-outline-primary me-1' href='edit.php?id=".$row['id_menu']."'>Edit</a>
                        <a class='btn btn-outline-danger' href='hapus.php?id=".$row['id_menu']."' onclick='return confirm(\"Hapus data ini?\")'>Hapus</a>
                    </td>
                </tr>";
                    $no++;
                }
